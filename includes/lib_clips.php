 ...
 * @return  array   $arr
 */
function get_collection_goods($img_url,$user_id, $num = 10, $start = 0)
{
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
    {
        ...
        $goods_imgsrc = $img_url.$row['goods_thumb']."_100X100.jpg";
        ...
        $goods_list[$row['goods_id']]['goods_thumb']        = $goods_imgsrc;
    }
