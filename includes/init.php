...
$ecs2 = new ECS($control_db_name, $prefix2);
...
$db2 = new cls_mysql($control_db_host, $control_db_user, $control_db_pass, $control_db_name);
$control_db_host = $control_db_user = $control_db_pass = NULL;
