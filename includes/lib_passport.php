...
function register($username, $password, $email, $other = array())
{
    ...
    else
    {
        ...
        //定义other合法的变量数组
         $other_key_array = array('FirstName', 'LastName', 'FirstName_2', 'LastName_2', 'mobile_phone', 'State', 'City', 'Room', 'AddressLine', 'PostalCode');
		...
		//插入用户信息到核心数据库
		$GLOBALS['db2']->autoExecute($GLOBALS['ecs2']->table('users'), $update_data, 'UPDATE', "email = '". $_SESSION['email'] ."' AND website_id = '".$GLOBALS['website_id']."'" );
        ...
        $address = array(
            ...
            'FirstName_2'       => $other['FirstName_2'],
            'LastName_2'   => $other['LastName_2'],
            'email'    => $email,
            'State'  => $other['State'],
            'City'      => $other['City'],
            'Room'        => $other['Room'],
