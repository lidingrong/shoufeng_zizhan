...
?>
			...
			<?php endif; ?>
			<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_81290600_1373515111');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_81290600_1373515111']):
?>
      <div class="screeBox">
			<strong><?php echo htmlspecialchars($this->_var['filter_attr_0_81290600_1373515111']['filter_attr_name']); ?> :</strong>
			<?php $_from = $this->_var['filter_attr_0_81290600_1373515111']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
