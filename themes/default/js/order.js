...
function tab_choice(tab, tabbox, curClass, etype){//选项卡切换函数, 变量tab、tabbox必须为jQuery对象
	var tabTId = '';
	if (etype){
		tab.hover(
			function (){
...
function zipcode(PostalCode, State, City, AddressLine){
	...
	zipcode_obj.open('GET', '/inc/zipcode.php?zipcode='+zip+'&r='+Math.random(), true);
