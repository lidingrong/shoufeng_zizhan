 ...
 */
    ...
    if ($order['user_id'] > 0)
    {
        ...
        // 地址信息
        $sql = "SELECT * FROM " . $ecs->table('user_address') . " WHERE user_id = '$order[user_id]' and IsDefault = '1' ";
...
function order_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT o.order_id, o.order_sn, o.add_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
                    "o.pay_status, o.consignee, o.State, o.email, o.Phone, o.extension_code, o.extension_id, " .
        ...
        foreach (array('order_sn', 'consignee', 'email', 'State', 'zipcode', 'Phone', 'user_name') AS $val)
        {
