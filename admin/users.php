...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $sql = "SELECT u.user_name, u.sex, u.birthday, u.pay_points, u.rank_points, u.user_rank , u.user_money, u.frozen_money, u.credit_line, u.parent_id, u2.user_name as parent_username, u.LastName, u.FirstName, u.FirstName_2, u.LastName_2, u.mobile_phone".
    ...
    $sql = "SELECT u.user_id, u.sex, u.birthday, u.pay_points, u.rank_points, u.user_rank , u.user_money, u.frozen_money, u.credit_line, u.parent_id, u2.user_name as parent_username, u.LastName, u.FirstName,u.FirstName_2, u.LastName_2, u.mobile_phone".
        " FROM " .$ecs->table('users'). " u LEFT JOIN " . $ecs->table('users') . " u2 ON u.parent_id = u2.user_id WHERE u.user_id='$_GET[id]'";
    ...
    if ($row)
    {
        ...
        $user['FirstName']            = $row['FirstName'];
        $user['FirstName_2']   = $row['FirstName_2'];
        $user['LastName_2']     = $row['LastName_2'];
...
//           " WHERE user_id='$id'";
      ...
      $sql = "SELECT `address_id`, `user_id`, `FirstName`, `LastName`, `FirstName_2`, `LastName_2`, `email`, `State`, `City`, `Room`, `AddressLine`, `Country`, `PostalCode`, `Phone` FROM " .$ecs->table('user_address'). " WHERE user_id='$id' and IsDefault = '1' ";
