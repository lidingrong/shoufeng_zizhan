...

{
...

    {
		...
		$smarty->assign('goods_parameter',     getGoodsParameter($goods_id));                     // 产品参数
 ...
 */
 ...
 function getGoodsParameter($goods_id){
	$sql= 'SELECT *  FROM  ' . $GLOBALS['ecs']->table('goods_parameter') . ' WHERE ProId = '.$goods_id." ORDER BY PId ASC ";
	$arr = array();
